...
export class ContractFilter {
    ...
    constructor(web3: SafeWeb3){
        if(web3.w3 === undefined) throw new Error("Cannot create filter due an invalid instance of Web3 Provided.");

        this.safe = web3;
        this.rules = { items: new Array<FilterRulesItem>() };
    }

    setRules(rules: FilterRulesItem[]): void { this.rules.items = rules; /*console.log("\x1b[36m[FILTER] Rules loaded.\x1b[0m");*/ }
    ...
    print(): void {
        ...
        else console.log("Load rules first.");
